...
# Define the corresponding points in two views
# points1 = np.array([[x1, y1], [x2, y2], [x3, y3], [x4, y4], [x5, y5]], dtype=float)
# points2 = np.array([[u1, v1], [u2, v2], [u3, v3], [u4, v4], [u5, v5]], dtype=float)
...
for i in range(np.shape(good_matches)[0]):
    ...
    p3ds.append(p3d)
print(p3ds)
# Print the recovered rotations and translations
